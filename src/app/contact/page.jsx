...
const ContactPage = () => {
  ...
  return (
    ...
    <div className="w-full md:w-1/2 mt-10 md:mt-0 md:pl-16 text-center md:text-left">
      <h2 className="text-3xl font-bold text-gray-900 dark:text-white">{t("contactTitle")}</h2>
      <p className="mt-4 text-gray-600 dark:text-gray-300">{t("contactDescription")}</p>
  
      {/* أيقونات وسائل التواصل */}
      <div className="mt-12 text-center md:text-left">
        <p className="text-lg text-gray-600 dark:text-gray-300">{t("contactText")}:</p>
    ...
    <span className="block text-xl font-semibold">{t("contactEmail")}</span>
