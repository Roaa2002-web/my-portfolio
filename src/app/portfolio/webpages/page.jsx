...
const WebProjectsPage = () => {
  const { t } = useTranslation(); // الحصول على الترجمة
  ...
  return (
    <div
      ...
      style={{ backgroundImage: "url('/images/snehal.jpg')" }}
    >
      <h1 className="text-3xl font-bold text-center text-gray-100 mt-16 mb-6">
        {t("webPagesTitle") || "جاري التحميل..."} {/* الترجمة هنا */}
      </h1>
      ...
      {loading && (
        <p className="text-lg text-gray-700 dark:text-gray-300">جاري التحميل...</p>
      )}
        ...
        {projects.map((project, index) => (
          ...
          >
            ...
            <div className="flex items-center space-x-2 mb-3">
              ...
              <h3 className="text-lg font-semibold text-gray-100 truncate w-60">
                {project.name}
              </h3>
            </div>
            ...
            >
              {t("visitWebsite")} <ArrowRight className="ml-2 w-5 h-5" />
            </a>
          </div>
        ))}
      </div>
